export default [
    {
        id: 'q1',
        text: 'Q1: Which of the following definitions best describes React.js?',
        answers: [
    ...
    {
        id: 'q2',
        text: 'Q2: What purpose do React hooks serve?',
        answers: [
    ...
    {
        id: 'q3',
        text: 'Q3: Can you identify what JSX is?',
        answers: [
    ...
    {
        id: 'q4',
        text: 'Q4: What is the most common way to create a component in React?',
        answers: [
    ...
    {
        id: 'q5',
        text: 'Q5: What does the term "React state" imply?',
        answers: [
    ...
    {
        id: 'q6',
        text: 'Q6: How do you typically render list content in React apps?',
        answers: [
    ...
    {
        id: 'q7',
        text: 'Q7: Which approach can NOT be used to render content conditionally?',
        answers: [
